    ...
    function () {
        ...
        $(function () {
            var curlvl,
                ...
                prevlvl = startlvl,
                lst = $("#toc"),
                tmp2 = $("<p class='r' lang='en'><span class='inl' title='Close' onclick='closeNav()'>&emsp;✖&emsp;</span></p><p class='inl' lang='en'><span onclick='goList()' title='all units of book'>&emsp;⇚&emsp;</span> <span onclick='goTop()' title='top of page'>&emsp;⇑&emsp;</span> <span title='pronunciation' onclick='toggleShow()'>[ ]</span> <span title='subject + predicate' onclick='toggleShow2()'>&emsp;≡&emsp;</span></p><hr class='h' />"),
